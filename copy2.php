...
if(isset($_POST['submit'])){
	...
	require 'db.php';
		$insert_query= "INSERT INTO ieee_content(userid,project_title,author_name_1,author_name_2,author_name_3,abstract,keyword,introduction,exsisting_system,parposed_system,conclusion,review_of_related_work,future_scope,rfer_1,rfer_2,rfer_3,rfer_4,rfer_5,rfer_6,student_name,college_name,rfer_7) VALUES ('$id','$project_title','$author_name_1','$author_name_2','$author_name_3','$abstract','$keyword','$introduction','$exsisting_system','$parposed_system','$conclusion','$review_of_related_work','$future_scope','$rfer_1','$rfer_2','$rfer_3','$rfer_4','$rfer_5','$rfer_6','$student_name','$college_name','$rfer_7')";
            ...
            <div class="form">
              ...
              <form  method="post" >
                ...
                <div class="form-group mt-3">
				  ...
				  <div class="form-group">
                  <input type="file" name="figures" class="form-control" id="name" placeholder="Image" required>
                </div> <br>
				  <div class="form-group mt-3">
                  ...
                  <input type="text" name="rfer_5" class="form-control" id="name" placeholder="Reference 5" required>
				   ...
				   <div class="form-group">
                  <input type="text" name="rfer_6" class="form-control" id="name" placeholder="Reference 6" required>
                </div><br>
                <div class="form-group">
                  <input type="text" name="rfer_7" class="form-control" id="name" placeholder="Reference 7" required>
                </div>
